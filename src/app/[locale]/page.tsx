...
export default function MainPage() {
  ...
  //           <h1 className="text-3xl">Đăng Ký Nhận Thông Tin Tư Vấn</h1>
    ...
    <>
      ...
      <div>
        ...
        <div className="max-w-[1200px] mx-auto py-0">
          ...
          <div className="min-h-[800px] bg-[url('/assets/img/construction/bg-get-info.jpg')] flex flex-col justify-center rounded-2xl bg-cover">
            <div className="relative py-3 sm:max-w-xl sm:mx-auto">
              <div className="absolute inset-0 bg-gradient-to-r from-indigo-700 to-purple-500 shadow-lg transform -skew-y-6 sm:skew-y-0 sm:-rotate-6 sm:rounded-3xl"></div>
              <div className="text-white relative px-4 py-10 bg-indigo-400 shadow-lg sm:rounded-3xl sm:p-20">
                <div className="text-center pb-6">
